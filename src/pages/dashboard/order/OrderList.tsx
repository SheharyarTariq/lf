...
import {OrderListProp} from "@/pages/dashboard/types";


const OrderList: React.FC = () => {
    const BASE_URL = import.meta.env.VITE_BASE_URL;
    const url = `${BASE_URL}/admin/orders`;
    const [selectedOrder, setSelectedOrder] = useState<OrderListProp | null>(null); // State to store selected order data
    const {data, error, loading, refetch} = useFetch<any>(url);

    const handleRowClick = (orderData: OrderListProp) => {
